 ...
 * becomes active, in the spirit of samuelnalangira.com/media/instrument-gallery.
...
export default function InstrumentGallery() {
  ...
  // Auto-advance. The show keeps moving on its own and only pauses while the
  // visitor is hovering the arrows or the dots, or when they have asked for
      ...
      <div className="container-x py-14 md:py-20">
        <div className="text-center mb-10 md:mb-12 max-w-2xl mx-auto">
          ...
          <p className="font-body text-body-md text-surface-variant mt-4">
            Each instrument is crafted by hand from wood, gourds and animal skins. Watch them come
