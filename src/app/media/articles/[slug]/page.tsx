...
const fallbackContent: Record<string, any> = {
  'the-story-of-the-adungu': {
    ...
    featuredImage: { url: '/OKema/pic2.jpeg' },
    excerpt:
      'An instrument passed down through generations, and what it means to play it today.',
    body: [
      'The Adungu is not just an instrument to me. It is a library, a teacher and a conversation partner all at once.',
      'I was seven when my grandfather first placed one in my hands. Not the smaller children\u2019s version, but his own. The wood was worn smooth where his fingers had rested for forty years, and the strings hummed before I even touched them, as if they remembered every song he had ever played.',
      'That is the thing about the Adungu: it is made of living things. Wood from a tree that stood by a river. Strings that were once animal hide. And when you play it you are not playing alone. Every musician who has held that same shape, every elder who sang along to the same tuning, every child who danced while their parent played, they are all in the room with you.',
